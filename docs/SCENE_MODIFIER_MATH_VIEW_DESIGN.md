...
- Parameter edits affect the real output: focused native render proof with nonempty/Orbit-change assertions and Scene pixel parity; preview artifact observed by the lead. Camera routing is structurally preserved.
