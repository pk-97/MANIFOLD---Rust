...
**Status:** IN PROGRESS · 2026-09-17 · Codex. Native grid repair and connected graphics events implemented (BUG-ywdj, BUG-657u); optional depth occlusion adds shared sampled-surface and scene-depth testing (D8). Broader mathematical presentation remains tracked in BUG-fgfk.
