...
- Now owed: **Peter's first judging pass at the rig** — wire one shipped card (Tesseract or Fluid Sim 2D recommended: kick + band sends cover their signature rows today) and judge against real music. Text review validates structure only, never taste (Peter, 2026-07-10).
