...
- **I4 — Tail frame-cost targets: ≤ 3 ms mean at 1920×1080 and ≤ 20 ms any frame at 4K.** Enforcement: `MANIFOLD_RENDER_TRACE=1` run on the acceptance scene at P1; both GPU measurements report warnings above their targets and keep performance work open. Timing overruns do not fail functional GPU proofs or unrelated landings.
