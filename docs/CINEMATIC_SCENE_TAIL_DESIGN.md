...
**Status:** IN PROGRESS — P0+P1+P2+P4 executed; P3 look-pass running (Peter). Owed: half-res DoF design phase (revived, figure on record); near reduction blocked by BUG-rdy0 (RT zero-intensity sun direction leak). Phase history lives in git. · k3 (lead)
