...
| Material port + 4 atoms (unlit/phong/pbr/cel), per-kind pipelines | `MATERIAL_SYSTEM_DESIGN.md` | Designed, now un-held. Multi-light + shadows are its §7 (Extension points (forward-looking)) extension points — consumed here, not reopened |
