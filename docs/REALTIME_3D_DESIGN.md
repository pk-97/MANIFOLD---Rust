...
- **P5 — Viewport Tier 1 (navigate).** ✅ **BUILT 2026-07-17** on `lane/realtime3d-viewport`
  (pending landing). Editor camera override in the preview context,
