...
**Execution contract:** read `docs/DESIGN_DOC_STANDARD.md` §5 (Phase briefs)–§6 and §8 before starting any phase. P1–P2 are full-hardened against today's code; P3–P4 carry pre-flight re-derivation commands.
