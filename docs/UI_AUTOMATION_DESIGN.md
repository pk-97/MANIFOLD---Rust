...
**Status:** APPROVED design, not built · 2026-07-03 · Fable · **baseline-reviewed 2026-07-05** (anchors spot-reverified; automation-lane surface added to P1/D5 scope; acceptance demos + §10 levels added; dev feature renamed `ui-automation`) — cleared for the build wave
