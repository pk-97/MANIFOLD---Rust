...
**Status:** IN PROGRESS — P1/P2 and P3 primary-window live control shipped. P4 generator/disconnect/native-handover flows are implemented and verified (2026-09-06); broader flow families and multiwindow support remain deferred.
...
- **P3 — Live primary window. SHIPPED 2026-09-06.** Shared-handler input, bounded private socket, target validation and native/disconnect handover are implemented and verified. Current types, limits, acceptance and deferred scope are in the live contract above.
