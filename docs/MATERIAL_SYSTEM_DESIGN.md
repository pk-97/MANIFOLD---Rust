...
**Status:** Design accepted 2026-05-27, awaiting implementation. Written as the contract for the implementation tranches that follow the Light + Shadow design audit.
