...
**Graduated 2026-07-12 (Fable, Peter's picks):** section 2 → [GBUFFER_DESIGN.md](GBUFFER_DESIGN.md) · section 6 (Deferred) → [CAMERA_AND_LENS_DESIGN.md](CAMERA_AND_LENS_DESIGN.md) + [CINEMATIC_POST_DESIGN.md](CINEMATIC_POST_DESIGN.md) (DoF/SSAO/motion blur) · section 8 → REALTIME_3D section 11 (PCSS, P9). **section 5 export quality tiers DROPPED by Peter 2026-07-12** ("Ignore the explicit per-scene export quality please" — quality knobs are ordinary explicit scene config; no tier mechanism). section 3 materials v2 DEPRIORITIZED by Peter 2026-07-12 (his assets are game models/photoscans; black-background hero scenes) — stays captured here, not designed. **section 4 volumetrics → [VOLUMETRIC_LIGHT_DESIGN.md](VOLUMETRIC_LIGHT_DESIGN.md) (graduated 2026-07-13, Fable + Peter — god rays for the Interim EP; froxels stay deferred there).** section 7 HDR, section 9 RT, section 10 animated glTF remain here awaiting their turn.
