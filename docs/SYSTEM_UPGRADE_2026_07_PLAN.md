...
## Wave 2 — lanes (W2-B + W2-C LANDED 2026-07-20: `f2ac71d9` BUG-265 live-bounds fix (closed `30f0cf05`), `66fe273f` drag survey — BUG-265-class recurs nowhere; BUG-280/281 stomp-flicker + BUG-282 per-tick undo flood filed. W2-A remains. WARNING: branch `lane/w2b-bug265-drag-geometry` tip `b8c0b683` is a POST-LANDING DUPLICATE re-commit from a confused lane re-run — never merge it; the real fix is on main via `f2ac71d9`.)
