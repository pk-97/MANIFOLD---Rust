...
identity). `docs/AUTOMATION_LANES_DESIGN.md` §4 (Override latch (the precedence rule)) (the `touched` latch semantics,
...
- **Read-back:** this doc §2 D4/D5/D12, §4 whole; `effects.rs:785-844`,
  `:1099-1186`, `:2446-2474`; `docs/DESIGN_DOC_STANDARD.md` §5 (Phase briefs)–§6. Restate the
