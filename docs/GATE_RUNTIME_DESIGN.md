...
**Status:** APPROVED design, not built · 2026-07-25 · k3 (lead) · approved in discussion same day ("This probably needs a design doc and then we can build it with Flash")
