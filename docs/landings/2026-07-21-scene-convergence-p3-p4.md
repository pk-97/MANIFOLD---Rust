...
- The design's section 7 named-not-fixed items (UI density section 5.4, emoji glyphs, BUG-239 harness live-modulation gap, BUG-240 flow rot) are unchanged by this landing.
