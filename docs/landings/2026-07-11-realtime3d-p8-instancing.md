...
**Branch:** `feat/realtime3d-p8-instancing` · **Level reached:** L3 / target L3 (section 10 — headless PNG read by the landing session; both the default-camera and a grazing-camera Garden render were inspected).
