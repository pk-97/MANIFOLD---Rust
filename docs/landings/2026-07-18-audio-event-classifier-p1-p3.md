...
**Doc status line (verbatim):** "IN PROGRESS — P1+P2+P3 executed 2026-07-18 (same day); heldout exam run, verdict SHORT OF BAR (see section 8): dev tuning plateaued … P4/P5 blocked on Peter's call: expand training data (D6 dial + more labeled shows / license-verified Splice) or park. ADTOF stays meanwhile; BUG-069 unchanged."
...
Heldout (one-shot, D8): liveshow kick 0.414 vs 0.909 · snare 0.218 vs 0.502 · hat 0.014 vs 0.619; E-GMD snare **0.723 vs 0.639 (only SHIP-grade line)**, kick 0.487/0.792, hat 0.194/0.496, perc 0.517/0.639; drums-filed-as-other 15.5% (bar <10%) FAIL. Full table + reading: design doc section 5b.
...
1. Design doc section 5b — the exam table; your call is one line: open the data dial or park.
