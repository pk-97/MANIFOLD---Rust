...
**Status:** IN PROGRESS — P1 (core pre-roll) + P2 (chains, image/LED, edit-time adds) shipped 2026-08-20; P3 (disk caches) implemented in lane/warmup-p3-disk-caches 2026-08-20; P4 not built · 2026-08-20 · k3 (lead)
**Prerequisites:** none
