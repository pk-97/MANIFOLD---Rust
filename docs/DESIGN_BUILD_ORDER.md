...
| SCENE_BUILD_AND_GROUP_PARAMS_DESIGN (P1 ✅ @ `3a6e30b7`, P2 ✅ 2026-07-10 (render_scene port swap + v1.12.0 migration + importer); P3–P5 remain) | P3's prereq (PARAM_STORAGE_BOUNDARIES P1–P2) ✅ satisfied 2026-07-09; REALTIME_3D P6 needs its P2 (now landed) | full |
