...
<!-- index: Live ledger of shipped-but-not-fully-verified surfaces. One entry per gap between the verification level a landing reached and its target; burned down or consciously carried every wave. Format and rules: DESIGN_DOC_STANDARD.md §10. (Verification levels, the debt ledger, and escapes (added 2026-07-05)) -->
...
Rules (normative home: `DESIGN_DOC_STANDARD.md` §10 (Verification levels, the debt ledger, and escapes (added 2026-07-05))):
