...
| Multi-object scene renderer, shared depth | `primitives/render_scene.rs` (`8daa89fc`) | Shipped P1. As-built outputs: `color` only — the lazy `depth` output promised in REALTIME_3D section 3 is **not built**; P4 here builds it |
