...
**Status:** IN PROGRESS — Tier 1+2, motion class, reflections R1–R3, T3-8 multi-bounce, sections 12–16 (AO, denoiser, env diffuse, many-light, translucency) landed; TL-B binary-scene overhead recovered; per-term RT toggles (shadows/AO/GI/reflections) live on the scene card. Section 17 DN built; Metal 4 denoiser hard-off confirmed Apple-side (BUG-woji (MTL4FX denoiser crash); repro in tools/mtl4fx_repro) — classic MetalFX denoiser is the operating point. OWED: Peter's looks — 17.7 fused re-look, DN-I upscaled pair, multi-bounce, R2 constants, fast-camera denoiser, ED-A hero scene, TL-C pink-pool pair; noise-gate re-baseline at default-flip. P5 export (D13), P6 frame interp show-triggered. · 2026-08-11 · K3 + Peter
