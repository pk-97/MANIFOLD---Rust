...
**Status: IN PROGRESS — P-P (projection split + scratch rider) SHIPPED 2026-07-21 (`docs/landings/2026-07-21-ui-funnel-p-p.md`); P-F2a (ui_root split, WS2) SHIPPED 2026-07-21 (`docs/landings/2026-07-21-ui-funnel-p-f2a-census.md`); P-B (DispatchCtx + chain-router dispatch split, amended D6) SHIPPED 2026-07-21 (`docs/landings/2026-07-21-ui-funnel-p-b.md` — dispatch_inspector 3,160-line fn → 36-line router + 7 domain modules; 18-arg dispatch → (action, ctx)); S8 flow manifest + runner SHIPPED (`0e566007`); P-F1 (app_render pure-move slices: editor_bridge.rs + frame/present.rs, −2,785 lines; frame-body stage split re-scoped to daytime semantic phase P-F1b per D-28 — D7's "pure move" phrasing was wrong for tick_and_render's inline stages; drag structs stay, they die at P-I) SHIPPED 2026-07-21; next daytime: P-F1b, P-D, P-F2, then P-I, P-S, P-Z; Peter unblocked execution 2026-07-21 ("my review does not block you unless it's critical") · 2026-07-21 · Fable**
