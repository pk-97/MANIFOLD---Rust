...
**Status: IN PROGRESS — P-P, P-B, P-F2a, P-F1, S8 SHIPPED 2026-07-21; P-D (intent-enum decomposition, flat-12 per amended D5) SHIPPED 2026-07-22 (landing report `docs/landings/2026-07-22-ui-funnel-p-d.md`); remaining: P-I (scrub wire — next, D-D3 kill list pre-derived), P-S (surface migration), P-Z (close) · 2026-07-22 · Fable**
