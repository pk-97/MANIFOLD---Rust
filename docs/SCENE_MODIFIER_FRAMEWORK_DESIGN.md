...
|---|---|---|
| INV-M1 | Trace is all-or-nothing per kind | Unit over fixture graphs per kind: full → applied; delete any required node → not applied (`trace_modifier_*` tests) |
