...
nine-pattern preset pack — value-gated at 8×120, all fused, zero new primitives). MVP-P3
designed 2026-09-04, not built (DMX first-class: `LayerType::Dmx` rename, hosts_generator
guard fixes, LED browser category — section 5b.4). Owed: MVP-P3 execution; Vec4 color
binding (own pass); in-app LED grid preview and original patch/sACN/island phases (deferred,
section 5b.5).**
