...
- **Visual-check queue (current):** MetallicGlass, QuadMirror, Kaleidoscope, Edge Stretch, Chromatic Aberration, Infrared, **Bloom**, **Dither**. (Kaleidoscope/EdgeStretch/QuadMirror now render — the remap fix un-broke them.) Legacy bundles for all of these stay registered until Peter's pass.
