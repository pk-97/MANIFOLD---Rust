...
**Status:** SHIPPED 2026-07-14 — all phases landed on `origin/main`. P1 (shared `tree_passes.rs::render_tree_overlay_passes`, D1/D2/D4, BUG-151 FIXED) @ `c8584b8d`. P2 (D6 redraw-keepalive aggregate + perf-HUD-in-editor demo) + P3 (D7 structural guard `tree_render_call_sites_are_allowlisted` + I2 fold-in + supersession sweep) landed together @ `9ea241dc`. Fable 5 (with Peter in the room) · Sonnet-executable
