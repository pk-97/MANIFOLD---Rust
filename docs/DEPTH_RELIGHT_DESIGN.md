...
**Status:** APPROVED 2026-07-17 (Peter, in-session, after the rendered probe sweep) — EXECUTING. P1/P2/P4 dispatched to Sonnet lanes same session; P3/P5/P6 follow. P4 ✅ LANDED (lane/depth-relight-p4 @ f2684402, not yet merged to main).
