...
**Status:** OPEN — HIGH (silent no-op on a live-performance control surface). Diagnosed this session; NOT fixed — see below for what was ruled out and what remains unproven.
