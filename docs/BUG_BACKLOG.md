...
|---|---|---|
| BUG-241 | **stage1-dsp-onset-frontend-misses-loud-real-kicks-track-dependent** | bake-off Stage-1 DSP onset front-end misses loud, clearly-present kicks on some electronic tracks — blocks a fair Stage-1-vs-ADTOF read — MED |
