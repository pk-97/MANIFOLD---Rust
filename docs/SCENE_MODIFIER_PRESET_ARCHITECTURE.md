...
Surface Peel - Clip Hit is a catalog variation of Surface Peel, not a new visual family. One Scene-stage gated beat envelope adds a bounded burst to independent base lift/curl across EachObject stages. The gate consumes the owner’s pre-event baseline; its downstream envelope starts from the gate’s zero counter. No animation is baked into a scan.
