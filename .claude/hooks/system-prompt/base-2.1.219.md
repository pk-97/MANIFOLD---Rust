# Claude Code default system prompt — extracted 2026-07-27 from a live Fable session, CC 2.1.219

Extraction notes: this is the narrative system prompt as composed for an interactive session.
Tool schemas are delivered separately and are NOT part of this text (they survive --system-prompt).
Blocks marked [SESSION-SPECIFIC] are composed per launch (environment, git status, memory paths,
