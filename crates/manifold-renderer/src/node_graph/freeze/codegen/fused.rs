...
pub(super) fn is_param_derived(node: &RegionNode<'_>, derived_name: &str) -> bool {
...
pub(super) fn split_fns(fragment: &str) -> (Vec<String>, Vec<FnBlock>) {
...
pub fn generate_fused(region: &FusionRegion<'_>) -> Result<GeneratedFusion, CodegenError> {
    ...
    {
        return super::fused_buffer::generate_fused_buffer(region);
    }
