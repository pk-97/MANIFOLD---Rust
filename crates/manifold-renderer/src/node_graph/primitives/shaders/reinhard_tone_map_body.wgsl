// node.reinhard_tone_map — fusable body (freeze section 12). Tone map in three curves
...
// is Enum -> u32. Log's white point is fixed at 64.0 (the section 6.4 constant-in-
