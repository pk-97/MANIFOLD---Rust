...
// shader's id + 0.5 bit-for-bit. The six threshold fns are verbatim from
// dither_pattern.wgsl. PARAMS: [algorithm] (Enum -> u32).
...
fn body(uv: vec2<f32>, dims: vec2<f32>, algorithm: u32) -> vec4<f32> {
