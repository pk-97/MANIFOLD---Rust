...
fn cs_main(@builtin(global_invocation_id) id: vec3<u32>) {
    ...
    let radius_px = (u.radius / (tan_half_fov * center_vz)) * (f32(dims.y) * 0.5);
    ...
    for (var s: u32 = 0u; s < n_slices; s = s + 1u) {
        ...
        for (var j: u32 = 0u; j < n_steps; j = j + 1u) {
            ...
            let s_plus = view_pos(c_plus, dims_i, tan_half_fov, aspect, u.near, u.far);
            ...
            let s_minus = view_pos(c_minus, dims_i, tan_half_fov, aspect, u.near, u.far);
