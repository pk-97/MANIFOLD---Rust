...
impl EffectNode for WgslCompute {
    ...
    fn evaluate(&mut self, ctx: &mut EffectNodeContext<'_, '_>) {
        ...
        // Pack the uniform: every member of the generic layout. Params stay
        // uniforms (COMPILE_CONTRACT_DESIGN D2) — no value-baked variants.
        if let Some(layout) = &self.uniform_layout {
                    ...
                    for m in &layout.members {
                        ...
                        // pack here; the dedicated loop below recomputes and
                        // writes it instead.
        ...
        // Now assemble the GpuBinding slice. Uniform Bytes points into the
        // uniform scratch.
        let active_scratch: &[u8] = &self.uniform_scratch;
