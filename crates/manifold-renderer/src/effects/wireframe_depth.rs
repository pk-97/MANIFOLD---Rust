...
inventory::submit! {
    EffectMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("wire_res", "WireRes", 0.5, 1.0, 1.0, "F2", "WireRes"),
            ParamSpec::whole_labels("mesh_rate", "MeshRate", 1.0, 4.0, 1.0, &["Every", "Half", "Third", "Quarter"], "MeshRate"),
            ...
            ParamSpec::continuous("edge_follow", "EdgeFollow", 0.0, 1.0, 0.5, "F2", "EdgeFollow"),
        ],
    }
}
inventory::submit! {
