...
impl ComputeBlitHelper {
    ...
    pub fn dispatch(
            ...
            && gpu.has_native_encoder()
        {
            ...
            // Extract source and target textures from wgpu views.
            // MUST drop each guard before acquiring the next (wgpu snatch lock).
            let native_source = unsafe {
