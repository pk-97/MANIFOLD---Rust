// Compute variant of fx_halation.wgsl for ComputeDualBlitHelper.
...
// Pass 2 (mode 2): Composite — source + blurred halo x amount
...
fn cs_main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    if uniforms.mode == 0u {
        ...
        // Pass 2: Composite — source + halo x amount
