...
impl PresetRuntime {
    ...
    pub fn from_def(
        ...
        // a convert (deserializes as Float), which both tripped the
        // into_graph convert check (graph refused → black layer) and
        // silently missed the Bool slot at runtime (dead toggle, effect
