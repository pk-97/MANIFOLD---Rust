...
impl FractalZoomGenerator {
    pub fn new(
        ...
        let shader_source = include_str!("shaders/fractal_zoom_compute.wgsl");
...
impl Generator for FractalZoomGenerator {
    ...
    fn render(
            ...
            && gpu.has_hal_encoder()
        {
            ...
            let uniform_size = std::mem::size_of::<FractalZoomUniforms>() as u64;
            ...
            let bg = unsafe {
                ...
                .expect("Failed to create FractalZoom hal bind group")
            };
