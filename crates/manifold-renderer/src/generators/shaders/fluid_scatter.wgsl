// FluidDensityScatter — mono atomic scatter + resolve.
//
// splat_main:   Each particle scatters energy via atomicAdd per texel.
// resolve_main: Converts uint accumulation → density float.
