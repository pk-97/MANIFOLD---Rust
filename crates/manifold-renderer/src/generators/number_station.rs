...
// Parameter indices matching Unity's NumberStationGenerator.cs
const MODE: usize = 0;
const SPEED: usize = 1;
const DENSITY: usize = 2;
const FONT: usize = 3;
const GLOW: usize = 4;
const FLICKER: usize = 5;
const COLOR: usize = 6;
const COLUMNS: usize = 7;

#[repr(C)]
#[derive(Clone, Copy, bytemuck::Pod, bytemuck::Zeroable)]
struct NumberStationUniforms {
    time: f32,
    beat: f32,
    aspect_ratio: f32,
    anim_speed: f32,
...
impl NumberStationGenerator {
    pub fn new(device: &wgpu::Device, target_format: wgpu::TextureFormat) -> Self {
        ...
        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("NumberStation Pipeline Layout"),
        ...
        let uniform_buffer = device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("NumberStation Uniforms"),
            size: std::mem::size_of::<NumberStationUniforms>() as u64,
...
impl Generator for NumberStationGenerator {
    fn generator_type(&self) -> &GeneratorTypeId {
        &GeneratorTypeId::NUMBER_STATION
    }
