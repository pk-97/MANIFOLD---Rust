...
const SETUPS: &[Setup] = &[
    Setup { label: "identity",        amount: 0.0, threshold: 0.5, spread: 0.5, hue: 20.0,  saturation: 0.6 },
    Setup { label: "default",         amount: 0.5, threshold: 0.5, spread: 0.5, hue: 20.0,  saturation: 0.6 },
    Setup { label: "low_threshold",   amount: 1.0, threshold: 0.1, spread: 0.5, hue: 20.0,  saturation: 0.6 },
    Setup { label: "high_threshold",  amount: 1.0, threshold: 0.9, spread: 0.5, hue: 20.0,  saturation: 0.6 },
    Setup { label: "wide_spread",     amount: 1.0, threshold: 0.5, spread: 1.0, hue: 20.0,  saturation: 0.6 },
    Setup { label: "blue_tint",       amount: 1.0, threshold: 0.5, spread: 0.5, hue: 240.0, saturation: 0.8 },
    Setup { label: "desaturated",     amount: 1.0, threshold: 0.5, spread: 0.5, hue: 20.0,  saturation: 0.0 },
    Setup { label: "full_amount",     amount: 1.0, threshold: 0.3, spread: 0.7, hue: 120.0, saturation: 1.0 },
];
