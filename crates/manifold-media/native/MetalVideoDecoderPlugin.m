...
static NSString* const kYuvToRgbaShaderSource =
    @"#include <metal_stdlib>\n"
     ...
     "\n"
     "    // Sample Y at full resolution, CbCr at half resolution\n"
     "    // Scale source coords if video resolution differs from output resolution\n"
     ...
     "    uint2 src_coord = uint2(uv * src_size);\n"
