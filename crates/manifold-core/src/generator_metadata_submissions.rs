...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ParamSpec::continuous("freq_x", "Freq X", 0.0, 2.0, 0.13, "F2", "freqX"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ParamSpec::continuous("sens_dist", "SensDist", 0.005, 0.1, 0.02, "F3", "sensdist"),
            ParamSpec::continuous("sens_angle", "SensAngle", 0.1, 1.5, 0.8, "F2", "sensangle"),
            ...
            ParamSpec::continuous("color", "Color", 0.0, 1.0, 0.08, "F2", "color"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("scale", "Scale", 0.25, 3.0, 1.0, "F2", "scale"),
            ParamSpec::continuous("count_m", "Count (M)", 0.1, 8.0, 2.0, "F1", "count"),
            ParamSpec::toggle("snap", "Snap", 0.0, 1.0, 0.0, "snap"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("ctr_scale", "Ctr Scale", 0.2, 1.0, 0.8, "F2", "containerScale"),
            ParamSpec::whole_labels("vol_res", "Vol Res", 0.0, 2.0, 0.0, &["64", "128", "256"], "volumeRes"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("wave_amp", "Wave Amp", 0.0, 0.5, 0.1, "F3", "waveAmp"),
            ParamSpec::continuous("wave_freq", "Wave Freq", 0.1, 2.0, 0.5, "F2", "waveFreq"),
            ...
            ParamSpec::continuous("light_int", "Light Int", 0.1, 10.0, 2.5, "F1", "lightInt"),
            ParamSpec::continuous("blur", "Blur", 0.0, 20.0, 10.0, "F0", "blur"),
            ParamSpec::continuous("cam_dist", "Cam Dist", 0.1, 10.0, 0.8, "F2", "camDist"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("edge_str", "Edge Str", 0.5, 20.0, 5.0, "F1", "edgeStr"),
            ...
            ParamSpec::continuous("light_int", "Light Int", 0.1, 10.0, 3.5, "F1", "lightInt"),
            ParamSpec::continuous("cam_dist", "Cam Dist", 0.5, 10.0, 2.5, "F2", "camDist"),
            ParamSpec::continuous("cam_orbit", "Cam Orbit", -180.0, 180.0, 0.0, "F0", "camOrbit"),
            ParamSpec::continuous("cam_tilt", "Cam Tilt", -90.0, 90.0, -10.0, "F0", "camTilt"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("vel_damp", "VelDamp", 0.85, 0.999, 0.98, "F3", "veldamp"),
            ...
            ParamSpec::continuous("sat", "Sat", 0.0, 2.0, 1.0, "F2", "sat"),
            ParamSpec::continuous("bright", "Bright", 0.0, 2.0, 1.0, "F2", "bright"),
            ParamSpec::continuous("vel_disp", "VelDisp", 0.1, 10.0, 1.0, "F2", "velDisp"),
            ParamSpec::continuous("col_disp", "ColDisp", 0.1, 10.0, 1.0, "F2", "colDisp"),
...
inventory::submit! {
    GeneratorMetadata {
        ...
        params: &[
            ...
            ParamSpec::continuous("anim_speed", "Anim Speed", 0.0, 1.0, 0.5, "F2", "animSpeed"),
            ParamSpec::continuous("morph", "Morph", 0.0, 1.0, 0.0, "F2", "morph"),
            ...
            ParamSpec::continuous("petal_amp", "Petal Amp", 0.0, 80.0, 60.0, "F0", "petalAmp"),
            ParamSpec::continuous("rot_speed", "Rot Speed", 0.0, 3.0, 0.3, "F2", "rotSpeed"),
            ParamSpec::continuous("box_scale", "Box Scale", 0.005, 0.08, 0.025, "F3", "boxScale"),
            ParamSpec::continuous("cam_dist", "Cam Dist", 0.5, 10.0, 3.5, "F1", "camDist"),
            ParamSpec::continuous("cam_orbit", "Cam Orbit", -180.0, 180.0, 0.0, "F0", "camOrbit"),
